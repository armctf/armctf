...
## downloading 
downloads handled by nextcloud at germany server and [ctfmirror](https://ctfmirror.com/) at canada server. both servers are mine and download urls given as direct links.
